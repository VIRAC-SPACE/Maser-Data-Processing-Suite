...
This package contains various scripts that allow create visualations for presentations and publications, these scripts should be executed from _publications_and_presentations_ folder.
