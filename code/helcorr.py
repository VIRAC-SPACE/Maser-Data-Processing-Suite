...
def helcorr(obs_long, obs_lat, obs_alt, ra2000, dec2000, jd, debug=True):
   """
...
dec = 62.0 + 1.0/60.0 + 46.7/3600.0;  
ra = 22.0 + 56.0/60.0 + 17.90/3600.0;
lat = '57:33:12.3' 
lat = 57.553417
altitude = 87.30
long = '-021:51:17'
long = -21.854722
print(helcorr(long, lat, altitude, ra, dec, 6987.8545138887130))
